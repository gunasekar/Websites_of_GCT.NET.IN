...
<body>
    ...
    <div class="container">
      ...
      <nav>
        <ul>
			...
			<li><a href="workshops.php" class="current">Workshops</a></li>
  ...
  <div class="main-box">
    ...
    <div class="container">
      <div class="inside">
        <h2 align="center">Workshops @ <span>IQ'12</span></h2>
        <?
			include "contents/workshop_content.php";
        ?>
      </div>
    </div>
  </div>

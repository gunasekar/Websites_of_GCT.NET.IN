...
<body>
  ...
  <div class="main-box">
	...
	?>
	<div class="container" align="right"><marquee><a href="shortlists.php?page=c">Cyrusso(Paper) Shortlists</a> | <a href="shortlists.php?page=o">Odyssey(Project) Shortlists</a></marquee></div>
    <div class="container">
      <div class="inside">
        <?
			if(isset($_GET['page'])){
				if($_GET['page'] == 'c')
				include "contents/cyrusso.html";
				else if($_GET['page'] == 'o')
				include "contents/odyssey.html";
				else
				include "contents/cyrusso.html";
			}
			else
